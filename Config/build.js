...
/** Tasks */
const digitalOceanSpacesUpload = {
  name: 'digitalOceanSpacesUpload',
  entry: {
    'DigitalOceanSpacesUpload/digitalOceanSpacesUpload': path.join(
      __dirname,
      '../Src/DigitalOceanSpacesUpload/digitalOceanSpacesUpload.ts'
    )
  },
  ...mainConfig
}

const digitalOceanSpacesDelete = {
  name: 'digitalOceanSpacesDelete',
  entry: {
    'DigitalOceanSpacesDelete/digitalOceanSpacesDelete': path.join(
      __dirname,
      '../Src/DigitalOceanSpacesDelete/digitalOceanSpacesDelete.ts'
    )
  },
  ...mainConfig
}
...
/** Tasks to execute */
const tasksExecute = [digitalOceanSpacesUpload, digitalOceanSpacesDelete]
...
function greeting () {
  ...
  if (cols > 85) text = 'DigitalOcean-tools'
  else if (cols > 60) text = 'DigitalOcean-|tools'
  else text = false
